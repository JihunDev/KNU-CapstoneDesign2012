...
public class SkeletonsGestures
{
     ...
     notify the watcher. */
  {
    ...
    rightHandUp(userID, skel); // START
    rightHandFwd(userID, skel); // FWD
    rightHandOut(userID, skel); // BWD
    rightHandIn(userID, skel); // TURN
    rightHandDown(userID, skel); // STOP

    leftHandUp(userID, skel); // COMPLETE
  }  // end of checkGests()
